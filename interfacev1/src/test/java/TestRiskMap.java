 ...
 * Description:
 */
public class TestRiskMap {
    public static void main(String[] args) {
        Map<String,String> dataMap=new HashMap<>();
        Map<String, Object> defaultHeaders = HttpUtils.getDefaultHeaders();
        String reponse = HttpUtils.doGet("http://10.100.1.129:7150/ss/sdm/rs/sd/config/label/list?labelType=RISK_LEVEL&labelName=&start=1&limit=2500", defaultHeaders);
